...
trackPixelEvent('Purchase', {
  ...
  currency: 'BDT'
    ...
    return (
        <div className="bg-white p-6 sm:p-8 rounded-[32px] shadow-sm border border-gray-100 space-y-6 max-w-4xl animate-in fade-in duration-300">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 border-b pb-6">
                <div>
                    ...
                    <p className="text-xs text-gray-400 font-bold">Configure Facebook Pixel for event tracking and analytics</p>
                </div>
            </div>
